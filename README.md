...
### <center>*Overall TrackPlant3D framework for tracking organ growth in time-series plant point clouds.*<br>*The framework includes three main steps—Step 1, point cloud processing; Step 2, estimating organ correspondences; and Step 3, growth tracking*</center>
![Overall TrackPlant3D framework for tracking organ growth in time-series plant point clouds.](img/TrackPlant3D.jpg "Overall TrackPlant3D framework for tracking organ growth in time-series plant point clouds.")
