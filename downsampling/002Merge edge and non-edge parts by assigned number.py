...
path_center = r'D:\Zealot\论文\2024-7-29\github模板\data\sampled_data\3Deps\3Deps_c'  # your core points directory path
path_edge = r'D:\Zealot\论文\2024-7-29\github模板\data\sampled_data\3Deps\3Deps_e'   # your edge points directory path
save_path = r'D:\Zealot\论文\2024-7-29\github模板\data\sampled_data\3Deps\merge'  # save path of merged points
...
for txt_c, txt_e in zip(txt_cs, txt_es):
        ...
        with open(os.path.join(save_path,txt_e.split('.')[0] + ".txt"), 'w') as f:
